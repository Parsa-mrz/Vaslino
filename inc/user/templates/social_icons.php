...
?>
 ...
 <div id="contact_us" class="me-5 d-flex flex-column align-items-start justify-content-end">
        <div id="contact_us_slide" class="">
            ...
            <?php
  if ($links['facebook']) {?>
              <a href="<?php echo esc_url( 'https://' . $links['facebook'] ) ?>"><li id="li_1"><i class="fa-brands fa-facebook-f fa-2xl "  style="color: #4267B2;"></i></li></a>
                <?php
  }if ($links['twitter']) {?>
              <a href="<?php echo esc_url( 'https://' . $links['twitter'] ) ?>"><li id="li_3"><i class="fa-brands fa-twitter fa-2xl " style="color: #00acee;"></i></li><a>
                <?php
  }if ($links['instagram']) {?>
              <a href="<?php echo esc_url( 'https://' . $links['instagram'] ) ?>"><li id="li_2"><i class="fa-brands  fa-instagram fa-2xl instagram"style="color: #e81f76;"></i></li><a>
  <?php 
  }if ($links['whatsapp']) {?>
      <a href="<?php echo esc_url( 'https://' . $links['whatsapp'] ) ?>"><li id="li_2"><i class="fa-brands  fa-whatsapp fa-2xl " style="color: #075E54;"></i></li><a>
  <?php 
  }
    ?>
          </ul>
